...
export function Skills() {
	return (
		...
		>
			<h2 className="mt-8 text-center text-3xl md:text-4xl">Main stack</h2>
			...
			<Accordion>
				<AccordionItem value="more-skills">
					...
					<AccordionPanel className="flex flex-col gap-4">
						...
						<p>
							JavaScript, TypeScript, Python, SQL, HTML, CSS, JSON, Markdown,
							XML
						</p>
						<h3 className="text-xl md:text-2xl">Technologies</h3>
						<p>React, Codex, Git, Docker, Zed, Shadcn/ui</p>
						<h3 className="text-xl md:text-2xl">Other skills</h3>
						<p>English (B2), Agile Methodologies</p>
					</AccordionPanel>
				</AccordionItem>
			</Accordion>
		</article>
