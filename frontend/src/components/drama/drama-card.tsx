	...
	return (
		<Link href={`/d/${drama.id}`} className="group focus:outline-none">
			<div className="relative aspect-2/3 overflow-hidden rounded-lg border transition-all group-hover:border-chart-2 group-hover:shadow-lg group-focus-visible:border-chart-2 group-focus-visible:shadow-lg">
				...
				{drama.rating != null && (
					<div className="absolute top-2 left-2 z-10 flex size-8 items-center justify-center rounded-full bg-chart-2 border-white border font-semibold text-sm text-white backdrop-blur-sm">
			...
			>
				<h3
					className="line-clamp-1 font-medium text-sm transition-colors group-hover:text-chart-2 group-focus:text-chart-2
				"
				>
